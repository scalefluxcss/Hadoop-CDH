 ...
 * 
 */
public class CSSZlibDecompressor implements Decompressor {
  private static final int DEFAULT_DIRECT_BUFFER_SIZE = 64*1024;
  private static final Log LOG = LogFactory.getLog(CSSZlibDecompressor.class);
  ...
  static {
      try {
        ...
        throw new RuntimeException("load libcsszjni.so error!", t);
      }
  }
   ...
   */
  public CSSZlibDecompressor(CompressionHeader header, int directBufferSize) {
    this.header = header;
  ...
  public CSSZlibDecompressor() {
    // this(CompressionHeader.DEFAULT_HEADER, DEFAULT_DIRECT_BUFFER_SIZE);
    this(CompressionHeader.AUTODETECT_GZIP_ZLIB, DEFAULT_DIRECT_BUFFER_SIZE);
  }
  ...
  public int decompress(byte[] b, int off, int len) 
    ...
    //System.out.println("decompress " + n + " bytes");
  ...
  public static class ZlibDirectDecompressor 
      extends CSSZlibDecompressor implements DirectDecompressor {
